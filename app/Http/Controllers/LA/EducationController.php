...
class EducationController extends Controller {
     ...
     public $listing_cols = ['id', 'title', 'school', 'type', 'begin', 'end', 'user_id'];
     ...
     public function dtajax() {
          ...
          if (Entrust::hasRole('SUPER_ADMIN')) {
               ...
               $values = DB::table('education')->select($this->listing_cols)->whereNull('deleted_at')->where("user_id", Auth::user()->id);
          }
