...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
   ...
   Route::get(config('laraadmin.adminRoute') . '/uploaded_filesOwner', 'LA\UploadsController@uploaded_filesOwner');
   ...
   Route::resource(config('laraadmin.adminRoute') . '/profile/', 'LA\EmployeesController@profile');
	...
	Route::get(config('laraadmin.adminRoute') . '/experiences_dt_ajax', 'LA\ExperiencesController@dtajax');
