		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				{!! Form::model($experience, ['route' => [config('laraadmin.adminRoute') . '.experiences.update', $experience->id ], 'method'=>'PUT', 'id' => 'experience-edit-form']) !!}
					...
					@la_input($module, 'comienzo')
					@la_input($module, 'fin')
					@la_input($module, 'descripcion')
					--}}
                    <br>
					<div class="form-group">
						{!! Form::submit( 'Guardar', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url(config('laraadmin.adminRoute') . '/experiences') }}">Cancelar</a></button>
					</div>
				{!! Form::close() !!}
			</div>
		</div>
