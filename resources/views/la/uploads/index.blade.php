...
@section("contentheader_title", "Biblioteca de documentos")
@section("contentheader_description", "Sube imágenes y ficheros")
@section("section", "Subidas")
@section("sub_section", "Listado")
@section("htmlheader_title", "Sube imágenes y ficheros")

@section("headerElems")
@la_access("Uploads", "create")
<button id="AddNewUploads" class="btn btn-success btn-sm pull-right">Añadir nuevo</button>
@endla_access
@endsection
...
<form action="{{ url(config('laraadmin.adminRoute') . '/upload_files') }}" id="fm_dropzone_main" enctype="multipart/form-data" method="POST">
    ...
    <div class="dz-message"><i class="fa fa-cloud-upload"></i><br>Arrastra aquí para subir</div>
</form>
    ...
    <div class="modal-dialog" role="document" style="width:90%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Fichero: </h4>
            </div>
            <div class="modal-body p0">
                <div class="row m0">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        ...
                        <div class="form-group">
                            <label for="caption">Etiqueta</label>
                        ...
                        <div class="form-group">
                            <label for="public">¿Es pública?</label>
...
<script>
     ...
     $("#EditFileModal .modal-title").html("Fichero: " + upload.name);
     ...
     $.ajax({
     dataType: 'json',
             url: "{{ url(config('laraadmin.adminRoute') . '/uploaded_filesOwner') }}",
